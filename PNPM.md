...
| Action                                     | Command                              |
| ------------------------------------------ | ------------------------------------ |
| Run a command in a specific package        | `pnpm --filter codex-sdk run build`  |
| Install a dependency in a specific package | `pnpm --filter codex-sdk add lodash` |
...
├── codex-sdk/             # Main package
│   └── package.json       # codex-sdk specific dependencies
