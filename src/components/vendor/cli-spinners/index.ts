...
export function randomSpinner() {
  const spinnersList = Object.keys(spinners) as Array<keyof typeof spinners>;
  const randomIndex = Math.floor(Math.random() * spinnersList.length);
  const spinnerName = spinnersList[randomIndex] as keyof typeof spinners;
  return spinners[spinnerName] as (typeof spinners)[keyof typeof spinners];
}
